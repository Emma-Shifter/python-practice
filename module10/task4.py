...
while True:
    movement = input("Выберите действие:\n1. Посмотреть текущий текст чата.\n2. Отправить сообщение.\nДействие: ")
    if (movement == "1"): print(get_chat_history())
    elif (movement == "2"): write_message(f"{name}:\t{input('Введите сообщение: ')}")
    else: print("Не удалось распознать команду.")